...
$sqlResult = $connect->prepare("select * from ad2_2019_technical_stage3
...
$sqlResult2 = $connect->prepare("select * from ad2_2019_technical_stage3
...
$adv_title = "نتيجة استيفاء الأوراق لوظيفة فني رابع | اعلان رقم 2 لسنة 2019";
$adv_link = "dkwasc.com.eg/jobs/job2_2019_technical/stage3/";
$job_no = " نتيجة استيفاء الأوراق للمتقدمين للاعلان رقم 2 لسنة 2019";
