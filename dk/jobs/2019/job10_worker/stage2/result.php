...
$sqlResult = $connect->prepare("select * from ad10_2019_worker_stage2
...
$sqlResult2 = $connect->prepare("select * from ad10_2019_worker_stage2
...
$adv_title = "مواعيد تقديم الأوراق لوظيفة عامل | اعلان رقم 10 لسنة 2019";
$adv_link = "dkwasc.com.eg/jobs/job10_2019_worker/stage2/";
$job_no = " مواعيد تقديم الأوراق للمتقدمين للاعلان رقم 10 لسنة 2019";
...
if ($q != -1) {
	...
	if (sizeof($result_data) <= 0) {
		//no result
		echo "<div class='alert alert-danger'>لا توجد نتائج للبحث !!!</div>";
	} else {
		//show result
		...
		echo        "<th class='text-center'>الاســـم</th>
						...
						<th class='text-center'>ميعاد تقديم الاوراق</th>
