...
<head>
    ...
    <title>تقرير اعلان رقم 10 لسنة 2019 | وظيفة عامل حفر وتسليك وتطهير</title>
...
<body>
    <div class="container text-center">
        ...
        <h3>تقرير اعلان رقم (10) لسنة 2019 </h3>
        ...
        $stmt = $connect->prepare("select count(*) as count,city from ad10_2019_worker group by city");
        $stmt->execute();
        $rows = $stmt->fetchAll();

        $stmt2 = $connect->prepare("select count(*) as countall from ad10_2019_worker");
        $stmt2->execute();
