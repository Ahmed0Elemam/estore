...
$sqlResult = $connect->prepare("select * from ad3_2019_worker_stage4_final
...
//$sqlResult = mysql_query($sql, $link) or die(mysql_error());
$sqlResult2 = $connect->prepare("select * from ad3_2019_worker_stage4_final
...
$adv_title = "النتيجة النهائية لوظيفة عامل | اعلان رقم 3 لسنة 2019";
$adv_link = "dkwasc.com.eg/jobs/job3_2019_worker/stage4_final/";
$job_no = "النتيجة النهائية للمتقدمين للاعلان رقم 3 لسنة 2019";
