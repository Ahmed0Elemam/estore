...
//database query
$sqlResult = $connect->prepare("select * from ad9_2019_reader_stage2 where id = $id");
$sqlResult->execute();
...
$gNotes = "<div class='text-center' style='width:100%;padding:5px;background-color:#F1F1F1;border:1px dashed red;color:red;'>
	...
	<ul>
        ...
        <li>تقديم اقرار ضامن من أحد العاملين بالجهات الحكومية أو احدى شركات القطاع العام أو قطاع الأعمال العام ويكون معتمد ومختوم بختم الجهة وبشرط أن يكون متبقي للضامن سنة على الأقل قبل الإحالة للمعاش وألا يكون ضامناً لأكثر من متقدم. 
        <br/>
        <p class='no-print'>
        يمكنك تحميل نموذج اقرار الضامن وطباعته وملئه من الرابط التالي
