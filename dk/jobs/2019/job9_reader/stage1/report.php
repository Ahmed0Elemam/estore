...
<body>
    <div class="container text-center">
        ...
        <h3>تقرير اعلان رقم 9 لسنة 2019 </h3>
        <div class="alert alert-info"><strong>وظيفة محصل بنظام العمولة</strong></div>
        <?php
        ...
        <?php
          ...
          $stmt = $connect->prepare("select count(*) as count,city from ad9_2019_reader group by city");
          $stmt->execute();
          $rows = $stmt->fetchAll();
          $stmt2 = $connect->prepare("select count(*) as countall from ad9_2019_reader");
          $stmt2->execute();
...
?>
            ...
            <p style="margin-top:10px;font-size:14px;">جميع الحقوق محفوظة © شركة مياه الشرب والصرف الصحي بالدقهلية 2019</p>
    </div>
