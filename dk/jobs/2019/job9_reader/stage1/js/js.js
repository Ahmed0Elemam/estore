 ...
 // setting error status
  ...
  $('#grade_year').blur(function () {
    if ($(this).val().length < 4) { // Show Error
     ...
     $('#study_name').blur(function () {
    if (!$(this).val()) { // Show Error
      $(this).css('border', '1px solid #f00').parent().find('.custom-alert').fadeIn(200).end().find('.astrik').fadeIn(100);
      study_nameErrors = true;
    } else {
      $(this).css('border', '1px solid #080').parent().find('.custom-alert').fadeOut(200).end().find('.astrik').fadeOut(100);
      study_nameErrors = false;
    }
  ...
  $('#register-form').submit(function (e) {
    if (nameErrors === true || nidErrors1 === true || dateErrors1 === true || dateErrors2 === true || dateErrors3 === true || dateErrors4 === true || mobErrors === true || militaryErrors === true || maritalErrors === true || villageErrors === true || cityErrors === true || studyErrors === true  || gyErrors === true || gy2Errors === true || study_nameErrors === true) {
      e.preventDefault();
      $('.name, .nid, #date, #military, #mobile, #marital, #village, #city, #study, #grade_year, #study_name').blur();
    }
