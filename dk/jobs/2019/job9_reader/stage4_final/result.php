...
$sqlResult = $connect->prepare("select * from ad9_2019_reader_stage4_final
...
//$sqlResult = mysql_query($sql, $link) or die(mysql_error());
$sqlResult2 = $connect->prepare("select * from ad9_2019_reader_stage4_final
...
$adv_title = "النتيجة النهائية لوظيفة محصل بالعمولة | اعلان رقم 9 لسنة 2019";
$adv_link = "dkwasc.com.eg/jobs/job9_2019_reader/stage4_final/";
$job_no = "النتيجة النهائية للمتقدمين للاعلان رقم 9 لسنة 2019";
