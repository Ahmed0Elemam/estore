...
<head>
    ...
    <meta property="og:title"  content="تقرير اعلان رقم 8 لسنة 2019 | وظيفة أخصائي خدمة عملاء ثالث" /> 
    ...
    <title> تقرير اعلان رقم 8 لسنة 2019 | وظيفة أخصائي خدمة عملاء ثالث</title>
...
<body>
    <div class="container text-center">
        ...
        <h3>تقرير اعلان رقم 8 لسنة 2019 </h3>
        <div class="alert alert-info"><strong>وظيفة أخصائي خدمة عملاء ثالث</strong></div>
        <?php
    ...
    <?php
           ...
           $stmt = $connect->prepare("select count(*) as count,city from ad8_2019_3omla group by city");
          $stmt->execute();
          $rows = $stmt->fetchAll();
        $stmt2 = $connect->prepare("select count(*) as countall from ad8_2019_3omla");
          $stmt2->execute();
