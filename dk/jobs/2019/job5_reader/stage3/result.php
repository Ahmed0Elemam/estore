...
$sqlResult = $connect->prepare("select * from ad5_2019_reader_stage3
...
//$sqlResult = mysql_query($sql, $link) or die(mysql_error());
$sqlResult2 = $connect->prepare("select * from ad5_2019_reader_stage3
...
$adv_title = "نتيجة استيفاء الأوراق لوظيفة محصل بالعمولة | اعلان رقم 5 لسنة 2019";
$adv_link = "dkwasc.com.eg/jobs/job5_2019_reader/stage3/";
$job_no = " نتيجة استيفاء الأوراق  للمتقدمين للاعلان رقم 5 لسنة 2019";
