...
<body>
    <div class="container text-center">
        ...
        <h3>تقرير اعلان رقم (7) لسنة 2019 </h3>
        ...
        $stmt = $connect->prepare("select count(*) as count,city from ad7_2019_technical group by city");
        $stmt->execute();
        $rows = $stmt->fetchAll();

        $stmt2 = $connect->prepare("select count(*) as countall from ad7_2019_technical");
        $stmt2->execute();
        $rows2 = $stmt2->fetchAll();
////////////////////////////
        $stmt3 = $connect->prepare("select count(*) as count3,city from ad7_2019_technical where study = 1 group by city ");
        $stmt3->execute();
        $rows3 = $stmt3->fetchAll();

        $stmt6 = $connect->prepare("select count(*) as countall3 from ad7_2019_technical where study = 1");
        $stmt6->execute();
        $rows6 = $stmt6->fetchAll();
//////////////////////////////
        $stmt4 = $connect->prepare("select count(*) as count4,city from ad7_2019_technical where study = 2  group by city");
        $stmt4->execute();
        $rows4 = $stmt4->fetchAll();

        $stmt7 = $connect->prepare("select count(*) as countall4 from ad7_2019_technical where study = 2");
        $stmt7->execute();
        $rows7 = $stmt7->fetchAll();
//////////////////////////////
        $stmt5 = $connect->prepare("select count(*) as count5,city from ad7_2019_technical  where study = 3 group by city");
        $stmt5->execute();
        $rows5 = $stmt5->fetchAll();

        $stmt8 = $connect->prepare("select count(*) as countall5 from ad7_2019_technical where study = 3");
        $stmt8->execute();
