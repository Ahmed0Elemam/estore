...
$sqlResult = $connect->prepare("select * from ad4_2019_gmstechnical_stage4_final
...
//$sqlResult = mysql_query($sql, $link) or die(mysql_error());
$sqlResult2 = $connect->prepare("select * from ad4_2019_gmstechnical_stage4_final
...
$adv_title = "النتيجة النهائية لوظيفة فني رابع | مركز جمصة فقط | اعلان رقم 4 لسنة 2019";
$adv_link = "dkwasc.com.eg/jobs/job4_2019_gmstechnical/stage4_final/";
$job_no = "النتيجة النهائية للمتقدمين للاعلان رقم 4 لسنة 2019";
