...
<body>
    <div class="container text-center">
        ...
        <h3>تقرير اعلان رقم 2 لسنة 2020 </h3>
        ...
        <?php
          ...
          $stmt = $connect->prepare("select count(*) as count,city from job2_2020_reader group by city");
          $stmt->execute();
          $rows = $stmt->fetchAll();
          $stmt2 = $connect->prepare("select count(*) as countall from job2_2020_reader");
          $stmt2->execute();
...
?>
            ...
            <p style="margin-top:10px;font-size:14px;">جميع الحقوق محفوظة © شركة مياه الشرب والصرف الصحي بالدقهلية 2020</p>
    </div>
