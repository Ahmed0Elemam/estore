...
$sqlResult = $connect->prepare("select * from ad1_2019_reader_stage6_final
...
//$sqlResult = mysql_query($sql, $link) or die(mysql_error());
$sqlResult2 = $connect->prepare("select * from ad1_2019_reader_stage6_final
...
$adv_title = "النتيجة النهائية لوظيفة محصل بالعمولة | اعلان رقم 1 لسنة 2019";
$adv_link = "dkwasc.com.eg/jobs/job1_2019_reader/stage6_final/";
$job_no = "النتيجة النهائية للمتقدمين للاعلان رقم 1 لسنة 2019";
