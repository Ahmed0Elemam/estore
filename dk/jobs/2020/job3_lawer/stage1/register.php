...
<head>
    ...
    <title> اعلان رقم 3 لسنة 2020 | وظيفة محامي ثالث</title>
...
<div class="container text-center">
        <div class="alert alert-info"><strong> استمارة التقديم لوظيفة محامي ثالث</strong></div>
            ...
            <div class="panel panel-primary text-center">
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control" name="study" id="study" required>
                                                ...
                                                <option value="1">ليسانس حقوق</option>
                                                <option value="2">ليسانس شريعة وقانون</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                        <div class="row">
                            <div class="alert alert-info">عضوية نقابة المحامين</div>
                            <div class="col-md-12">
                                <div class="col-md-4">
                                    <label>تاريخ القيد أمام المحاكم الإبتدائية</label>
                                    <span class="astrik">*</span>
                                </div>
                                <div class="col-md-8">
                                    <input id="nekaba_date" class="form-control" type="text" name="nekaba_date" placeholder="أدخل تاريخ القيد أمام المحاكم الإبتدائية" required readonly />
                                    <div class="alert alert-danger custom-alert"> الرجاء اختيار تاريخ القيد من قائمة التاريخ التي تظهر لك عند الضغط </div>
                                </div>
