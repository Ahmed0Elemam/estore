...
//database query
	...
	$sql = "select * from ad9_2016_driver_stage3
...
?>
  ...
  <body>
    <div class="container text-center">
      ...
      <h3>
        نتيجة استيفاء الاوراق للمتقدمين للاعلان رقم (9) لسنة 2016
      </h3>
	...
	if($q != -1) {
		...
		if( sizeof($result_data) <= 0){
			...
			echo		"<th class='text-center'>الاســـم</th>
						...
						<th class='text-center'>نتيجة استيفاء الاوراق</th>
