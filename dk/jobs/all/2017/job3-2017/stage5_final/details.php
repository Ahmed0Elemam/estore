...
//database query
	...
	$sql = "select * from ad3_2017_final
			where id = {$id}";
...
<head>
    ...
    <meta property="og:title"  content="النتيجة النهائية لوظيفة فني مساحة رابع اعلان رقم 3 لسنة 2017 | شركة مياه الشرب والصرف الصحى بالدقهلية" /> 
    ...
    <title>النتيجة النهائية لوظيفة فني مساحة رابع اعلان رقم 3 لسنة 2017 | شركة مياه الشرب والصرف الصحى بالدقهلية</title>
...
<body>
    <div class="container text-center">
        ...
        <div class="all">
            <div class="header">
                <h3>
                    النتيجة النهائية للمتقدمين المستوفين لشروط الاعلان رقم (3) لسنة 2017
                </h3>
                <h4>
      ...
      <table id="details" class='table table-bordered text-center'>
		...
		if(is_numeric($sqlData['ordering'])){		 
          ...
          <tr>
            ...
            <td class="danger text-right" style="font-weight:600;">
              <p class="text-danger text-center">الترتيب على مستوى الوظيفة</p>
