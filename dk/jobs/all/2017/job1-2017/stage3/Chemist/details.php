...
//database query
	...
	$sql = "select * from ad1_2017_chemist_stage3
			where id = {$id}";
...
// close database connection
  ...
  <head>
    ...
    <meta name="description" content="شركة مياه الشرب والصرف الصحى بالدقهلية - وظائف كيميائى (كيمياء خاص - كيمياء ونبات - كيمياء وحيوان)" />
    <meta name="author" content="Eng. Ahmed Elemam">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="robots" content="all" />
    <META HTTP-EQUIV="Pragma" CONTENT="no-cache" />
    <title> اعلان 1 لسنة 2017 | وظائف شركة مياه الشرب والصرف الصحي بالدقهلية</title>
  ...
  <body>
    <div class="container text-center">
      ...
      <h3>
        نتيجة استيفاء الأوراق ومواعيد الاختبار التحريري للمتقدمين للاعلان رقم (1) لسنة 2017
      </h3>
      ...
      <table id="details" class='table table-bordered text-center'>
        ...
        <?php if($sqlData['result'] == 1){ ?>
          <tr>
            <td class='text-center success' style='color:#000;vertical-align:middle;'>مواعيد الاختبار التحريري</td>
            <td>
      ...
      <div id="footer">
        ...
        <a class="btn btn-success" href='index.php'>صفحة البحث</a>
