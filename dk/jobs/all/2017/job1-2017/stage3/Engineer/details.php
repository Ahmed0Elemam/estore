...
//database query
	...
	$sql = "select * from ad1_2017_engineer_stage3
			where id = {$id}";
...
// close database connection
 ...
 ?>
  ...
  <head>
    ...
    <meta name="description" content="شركة مياه الشرب والصرف الصحى بالدقهلية - وظيفة مهندس ميكانيكا" />
  ...
  <body>
    <div class="container text-center">
      ...
      <h4 class="alert alert-info">
        <strong>  وظيفة مهندس ميكانيكا </strong>
      </h4>
      <hr/>
