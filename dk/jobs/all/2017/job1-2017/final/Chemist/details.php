...
//database query
	...
	$sql = "select * from ad1_2017_chemist_final
			where id = {$id}";
...
// close database connection
  ...
  <head>
    ...
    <meta name="description" content="وظائف كيميائي (كيمياء خاص - كيمياء ونبات - كيمياء وحيوان) | شركة مياه الشرب والصرف الصحي بالدقهلية" />
    <meta name="author" content="Eng. Ahmed Elemam" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta name="robots" content="all" />
    <META HTTP-EQUIV="Pragma" CONTENT="no-cache" />
   <title>النتيجة النهائية للاعلان رقم 7 لسنة 2016 والاعلان رقم 1 لسنة 2017 | وظائف شركة مياه الشرب والصرف الصحي بالدقهلية</title>
  ...
  <body>
    ...
    <h3>
      النتيجة النهائية للمتقدمين المستوفين لشروط الاعلان رقم 7 لسنة 2016 والاعلان رقم 1 لسنة 2017
    </h3>
    <h4 class="alert alert-info"><strong>
        وظيفة كيميائي ( كيمياء خاص - كيمياء ونبات - كيمياء حيوان)
      </strong></h4>
      <hr/>
      ...
      <table id="details" class='table table-bordered text-center'>
		...
		if($sqlData){ ?>
          ...
          <tr>
            <td class='text-center success' style='color:#000;vertical-align:middle;'>التخصص</td>
            <td>
