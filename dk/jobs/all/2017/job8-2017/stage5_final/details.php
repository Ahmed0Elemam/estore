...
//database query
	...
	$sql = "select * from ad8_2017_reader_stage5_final
			where id = {$id}";
...
<head>
    ...
    <meta property="og:title"  content="النتيجة النهائية لوظيفة محصل بالعمولة اعلان رقم 8 لسنة 2017" /> 
    ...
    <title>النتيجة النهائية لوظيفة محصل بالعمولة اعلان رقم 8 لسنة 2017 | وظائف شركة مياه الشرب والصرف الصحي بالدقهلية</title>
...
<body>
    <div class="container text-center">
        ...
        <div class="all">
            <div class="header">
                <h3>
                    النتيجة النهائية للمتقدمين المستوفين لشروط الاعلان رقم (8) لسنة 2017
                </h3>
                <h4>
                    وظيفة محصل بالعمولة 
                </h4>
