...
//database query
	...
	$sql = "select * from ad9_2017_driver_stage5_final
			where id = {$id}";
...
<head>
    ...
    <meta property="og:url"    content="http://www.dkwasc.com.eg/jobs/ad9_2017_driver/stage5_final/" /> 
    <meta property="og:title"  content="النتيجة النهائية لوظيفة سائق | اعلان رقم 9 لسنة 2017" /> 
    ...
    <title>النتيجة النهائية لوظيفة سائق | اعلان رقم 9 لسنة 2017 </title>
...
<body>
    <div class="container text-center">
        ...
        <div class="all">
            <div class="header">
                <h3>
                    النتيجة النهائية للمتقدمين المستوفين لشروط لااعلان رقم (9) لسنة 2017
                </h3>
                <h4>
                    وظيفة سائق <br/>
      ...
      <table id="details" class='table table-bordered text-center'>
        <?php
          ...
          <tr>
            <td class='text-center success' style='color:#000;vertical-align:middle;'>درجة القيادة</td>
            <td>
		...
		if(is_numeric($sqlData['ordering'])){		 
          ...
          <tr>
            <td class='text-center success' style='color:#000;vertical-align:middle;'>الترتيب</td>
