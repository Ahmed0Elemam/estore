...
//database query
	...
	$village = 'village';
	$tzlm = 'tzlm';
	$sql = "select * from ad4_2017_engineer_stage3_tzlm
...
<head>
    ...
    <meta property="og:title"  content="نتيجة التظلمات من نتيجة استيفاء الأوراق للمتقدمين للاعلان رقم 4 لسنة 2017 | وظيفة مهندس ثالث" /> 
    ...
    <title>نتيجة التظلمات من نتيجة استيفاء الأوراق للمتقدمين للاعلان رقم 4 لسنة 2017 | وظائف شركة مياه الشرب والصرف الصحي بالدقهلية</title>
...
<body>
    <div class="container text-center">
        ...
        <div class="all">
            <div class="header">
                <h3>
                     نتيجة التظلمات من نتيجة استيفاء الأوراق للمتقدمين للاعلان رقم (4) لسنة 2017
                </h3>
                <h4>
                    وظيفة مهندس ثالث
