...
//database query
	...
	$sql = "select * from ad4_2017_engineer_stage6_final
			where id = {$id}";
...
<head>
    ...
    <meta property="og:title"  content="النتيجة النهائية لوظيفة مهندس ثالث اعلان رقم 4 لسنة 2017" /> 
    ...
    <title>النتيجة النهائية للمتقدمين المستوفين لشروط الاعلان رقم 4 لسنة 2017 | وظائف شركة مياه الشرب والصرف الصحي بالدقهلية</title>
...
<body>
    <div class="container text-center">
        ...
        <div class="all">
            <div class="header">
                <h3>
                    النتيجة النهائية للمتقدمين المستوفين لشروط لااعلان رقم (4) لسنة 2017
                </h3>
                <h4>
                    وظيفة مهندس ثالث
                    <br/> ( ميكانيكا قوى - كهرباء قوى )
                </h4>
            </div>
      ...
      <table id="details" class='table table-bordered text-center'>
        <?php
          ...
          <tr>
            <td class='text-center success' style='color:#000;vertical-align:middle;'>التخصص المتقدم له</td>
            <td>
