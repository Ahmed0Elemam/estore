...
//database query
	...
	$village 		 = 'village';
	$ordering		 = 'ordering';
	$sql = "select * from ad2_2017_worker_final
...
<head>
  ...
  <title>النتيجة النهائية للاعلان 2 لسنة 2017 | شركة مياه الشرب والصرف الصحي بالدقهلية</title>
...
<body>
  <div class="container text-center">
    ...
    <h3>
      النتيجة النهائية للمتقدمين المستوفين لشروط الاعلان رقم (2) لسنة 2017
    </h3>
