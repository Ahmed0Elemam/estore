...
<head>
    ...
    <meta property="og:title"  content="نتيجة استيفاء الأوراق للمتقدمين للاعلان رقم 6 لسنة 2017 | وظيفة مراقب أمن رابع" /> 
    ...
    <title>نتيجة استيفاء الأوراق للمتقدمين للاعلان رقم 6 لسنة 2017 | وظائف شركة مياه الشرب والصرف الصحي بالدقهلية</title>
...
<body>
    <div class="container text-center">
        ...
        <div class="all">
            <div class="header">
                <h3>
                    نتيجة استيفاء الأوراق للمتقدمين للاعلان رقم (6) لسنة 2017
                </h3>
                <h4>
