...
//database query
	...
	$sql = "select * from ad6_2017_security_stage3
			where id = {$id}";
...
// close database connection
 ...
 ?>
    ...
    <head>
        ...
        <meta name="description" content="وظيفة مراقب أمن رابع | شركة مياه الشرب والصرف الصحي بالدقهلية" />
        <meta name="author" content="Eng. Ahmed Elemam">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="robots" content="all" />
        <META HTTP-EQUIV="Pragma" CONTENT="no-cache" />
        <title>اعلان رقم 6 لسنة 2017 | وظائف شركة مياه الشرب والصرف الصحي بالدقهلية</title>
