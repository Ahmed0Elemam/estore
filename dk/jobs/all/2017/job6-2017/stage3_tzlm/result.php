...
//database query
	...
	$village = 'village';
	$tzlm = 'tzlm';
	$sql = "select * from ad6_2017_security_stage3_tzlm
...
<head>
    ...
    <meta property="og:title"  content="نتيجة التظلمات من نتيجة استيفاء الأوراق للمتقدمين للاعلان رقم 6 لسنة 2017 | وظيفة مراقب أمن رابع" /> 
    ...
    <title>نتيجة التظلمات من نتيجة استيفاء الأوراق للمتقدمين للاعلان رقم 6 لسنة 2017 | وظائف شركة مياه الشرب والصرف الصحي بالدقهلية</title>
...
<body>
    <div class="container text-center">
        ...
        <div class="all">
            <div class="header">
                <h3>
                    نتيجة التظلمات من نتيجة استيفاء الأوراق للمتقدمين للاعلان رقم (6) لسنة 2017
                </h3>
                <h4>
                    وظيفة مراقب أمن رابع <br/> ( دبلوم تجارة - معهد فني تجاري )
                </h4>
            </div>
	...
	if($q != -1) {
		...
		if( sizeof($result_data) <= 0){
			...
			echo		"<th class='text-center'>الاســـم</th>
						...
						<th class='text-center'>نتيجة التظلم</th>
