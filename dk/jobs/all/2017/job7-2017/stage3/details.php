...
//database query
	...
	$sql = "select * from ad7_2017_worker_stage3
			where id = {$id}";
...
// close database connection
 ...
 ?>
    ...
    <head>
        ...
        <title>اعلان رقم 7 لسنة 2017 | وظائف شركة مياه الشرب والصرف الصحي بالدقهلية</title>
        <link rel="SHORTCUT ICON" href="../img/icon.gif" type="image/x-icon" />
        <link rel="stylesheet" href="../css/bootstrap.min.css">
        <link rel="stylesheet" href="../css/bootstrap-rtl.min.css">
        <link rel="stylesheet" href="../css/font-awesome.css">
        <link href="https://fonts.googleapis.com/css?family=Cairo:400,600و700&amp;subset=arabic" rel="stylesheet">
    ...
    <body>
        <div class="container text-center">
            ...
            <div class="all">
                <div class="header">
                    <h3>
                        نتيجة استيفاء الأوراق للمتقدمين للاعلان رقم (7) لسنة 2017
                    </h3>
                    <h4>
				...
				if($sqlData){ ?>
                    ...
                    <tr>
                            <td class='text-center success' style='color:#000;vertical-align:middle;'>الشهادة الدراسية المتقدم بها</td>
                            <td>
