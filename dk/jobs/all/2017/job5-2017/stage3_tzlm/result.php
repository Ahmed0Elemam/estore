...
//database query
	...
	$village = 'village';
	$tzlm = 'tzlm';
	$sql = "select * from ad5_2017_technical_stage3_tzlm
...
<head>
    ...
    <meta property="og:title"  content="نتيجة التظلمات من نتيجة استيفاء الأوراق للمتقدمين للاعلان رقم 5 لسنة 2017 | وظيفة فني رابع" /> 
    ...
    <title>نتيجة التظلمات من نتيجة استيفاء الأوراق للمتقدمين للاعلان رقم 5 لسنة 2017 | وظائف شركة مياه الشرب والصرف الصحي بالدقهلية</title>
...
<body>
    <div class="container text-center">
        ...
        <div class="all">
            <div class="header">
                <h3>
                    نتيجة التظلمات من نتيجة  استيفاء الأوراق للمتقدمين للاعلان رقم (5) لسنة 2017
                </h3>
                <h4>
                    وظيفة فني رابع <br/> ( أعمال صحية - ميكانيكا - كهرباء )
                </h4>
            </div>
