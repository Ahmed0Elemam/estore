...
//database query
	...
	$sql = "select * from ad5_2017_technical_stage3
			where id = {$id}";
...
// close database connection
 ...
 ?>
    ...
    <head>
        ...
        <meta name="description" content="وظيفة فني رابع | شركة مياه الشرب والصرف الصحى بالدقهلية" />
        <meta name="author" content="Eng. Ahmed Elemam">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="robots" content="all" />
        <META HTTP-EQUIV="Pragma" CONTENT="no-cache" />
        <title>اعلان رقم 5 لسنة 2017 | وظائف شركة مياه الشرب والصرف الصحي بالدقهلية</title>
    ...
    <body>
        <div class="container text-center">
            ...
            <div class="all">
                <div class="header">
                    <h3>
                        نتيجة استيفاء الأوراق للمتقدمين للاعلان رقم (5) لسنة 2017
                    </h3>
                    <h4>
