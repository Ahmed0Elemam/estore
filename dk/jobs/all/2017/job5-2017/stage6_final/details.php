...
//database query
	...
	$sql = "select * from ad5_2017_technical_stage6_final
			where id = {$id}";
...
<head>
    ...
    <meta property="og:url"    content="http://www.dkwasc.com.eg/jobs/ad5_2017_technical/stage6_final/" /> 
    <meta property="og:title"  content="النتيجة النهائية لوظيفة فني رابع | اعلان رقم 5 لسنة 2017" /> 
    ...
    <title>النتيجة النهائية للمتقدمين المستوفين لشروط الاعلان رقم 5 لسنة 2017 | وظيفة فني رابع</title>
...
<body>
    <div class="container text-center">
        ...
        <div class="all">
            <div class="header">
                <h3>
                    النتيجة النهائية للمتقدمين المستوفين لشروط الاعلان رقم (5) لسنة 2017
                </h3>
                <h4>
                    وظيفة فني رابع
                    <br/> ( أعمال صحية - ميكانيكا - كهرباء )
                </h4>
            </div>
      ...
      <table id="details" class='table table-bordered text-center'>
		...
		if(is_numeric($sqlData['ordering'])){		 
          ...
          <tr>
            ...
            <td style='padding:10px;border-radius:10px;background-color:#305d6d;color:#fff;border-radius:0;font-size:25px;'>
         ...
         <tr>
					...
					<td class="alert alert-danger"><strong>الترتيب على مستوى مركز 
                      <?php echo ' '.$sqlData['city_name']; ?>  وتخصص 
                      <?php echo $arr_study[intval($sqlData['study'])];?>
                      </strong></td>
      ...
      <div id="footer">
                ...
                <br/>
                <br/>
                <p>جميع حقوق الطبع محفوظة - شركة مياه الشرب والصرف الصحي بالدقهلية © 2018</p>
            </div>
    </div>
