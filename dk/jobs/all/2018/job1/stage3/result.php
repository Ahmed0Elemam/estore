...
//database query
	...
	$exam_date = 'exam_date';
	$sql = "select * from ad1_2018_reader_stage3
...
<head>
    ...
    <meta property="og:title"  content="نتيجة استيفاء الأوراق ومواعيد الاختبار التحريري لوظيفة محصل بالعمولة | اعلان رقم 1 لسنة 2018" /> 
    ...
    <title>نتيجة استيفاء الأوراق ومواعيد الاختبار التحريري لوظيفة محصل بالعمولة | اعلان رقم 1 لسنة 2018</title>
...
<body>
    <div class="container text-center">
        ...
        <div class="all">
            <div class="header">
                <h3>
                    نتيجة استيفاء الأوراق ومواعيد الاختبار التحريري للمتقدمين للاعلان رقم 1 لسنة 2018
                </h3>
                <h4>
