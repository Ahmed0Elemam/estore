...
<head>
    ...
    <meta property="og:url"    content="http://www.dkwasc.com.eg/jobs/ad1_2018_reader/stage3/" /> 
    <meta property="og:title"  content="نتيجة استيفاء الأوراق ومواعيد الاختبار التحريري لوظيفة محصل بالعمولة | اعلان رقم 8 لسنة 2018" /> 
    ...
    <title>نتيجة استيفاء الأوراق ومواعيد الاختبار التحريري لوظيفة محصل بالعمولة | اعلان رقم 8 لسنة 2018</title>
...
<body>
    <div class="container text-center">
        ...
        <div class="all">
            <div class="header">
                <h3>
                    نتيجة استيفاء الأوراق ومواعيد الاختبار التحريري للمتقدمين للاعلان رقم 8 لسنة 2018
                </h3>
                <h4>
            ...
            <div class="alert alert-danger text-right">
                <p><strong>تنويه هام</strong></p>
                <p> نتيجة الاستيفاء للمتقدمين من مركزي المطرية والمنزلة فقط</p>
