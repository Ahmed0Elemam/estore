...
//database query
	...
	$sql = "select * from ad8_2018_reader_stage4_2_final
			where id = {$id}";
...
<head>
    ...
    <meta property="og:title"  content="النتيجة النهائية لوظيفة محصل بالعمولة اعلان رقم 5 لسنة 2018" /> 
    ...
    <title>النتيجة النهائية لوظيفة محصل بالعمولة اعلان رقم 5 لسنة 2018 </title>
...
<body>
    <div class="container text-center">
        ...
        <div class="all">
            <div class="header">
                <h3>
                    النتيجة النهائية للمتقدمين المستوفين لشروط الاعلان رقم (5) لسنة 2018
                </h3>
                <h4>
                    وظيفة محصل بالعمولة 
                </h4>
