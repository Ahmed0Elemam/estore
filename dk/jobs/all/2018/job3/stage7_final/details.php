...
//database query
	...
	$sql = "select * from ad3_2018_chemist_stage7_final
			where id = {$id}";
...
<head>
    ...
    <meta property="og:title"  content="النتيجة لنهائية لوظيفة كيميائي | اعلان رقم 3 لسنة 2018" /> 
    ...
    <title>النتيجة النهائية للمتقدمين المستوفين لشروط الاعلان رقم 3 لسنة 2018 | وظيفة كيميائي</title>
...
<body>
    <div class="container text-center">
        ...
        <div class="all">
            <div class="header">
                <h3>
                    النتيجة النهائية للمتقدمين المستوفين لشروط الاعلان رقم (3) لسنة 2018
                </h3>
                <h4>
                    وظيفة كيميائي
                    <br/>
