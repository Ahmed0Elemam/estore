...
//database query
	...
	$sql = "select * from ad2_2018_engineer_stage6_final
			where id = {$id}";
...
<head>
    ...
    <meta property="og:url"    content="http://www.dkwasc.com.eg/jobs/ad4_2017_engineer/stage6_final/" /> 
    <meta property="og:title"  content="النتيجة النهائية لوظيفة مهندس مدني | اعلان 2 لسنة 2018" /> 
    ...
    <title>النتيجة النهائية لوظيفة مهندس مدني | اعلان 2 لسنة 2018 </title>
...
<body>
    <div class="container text-center">
        ...
        <div class="all">
            <div class="header">
                <h3>
                    النتيجة النهائية للمتقدمين المستوفين لشروط الاعلان رقم (2) لسنة 2018
                </h3>
                <h4>
                    وظيفة مهندس مدني
      ...
      <table id="details" class='table table-bordered text-center'>
        <?php
          ...
          <tr>
            <td class='text-center info' style='color:#000;vertical-align:middle;'>الدرجة التخصصية</td>
            <td>
              <?php echo $arr_special[intval($sqlData['special'])];?>
            </td>
          </tr>
		...
		if(is_numeric($sqlData['ordering'])){		 
         ...
         <tr>
					...
					<td class="alert alert-danger"><strong>
                      الترتيب على مستوى الدرجة التخصصية 
                      </strong></td>
