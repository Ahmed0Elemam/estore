...
//database query
	...
	$sql = "select * from ad2_2018_engineer_stage3
			where id = {$id}";
...
// close database connection
 ...
 <head>
    ...
    <meta property="og:url"    content="http://www.dkwasc.com.eg/jobs/ad2_2018_engineer/stage3/" />
    <meta property="og:title"  content="نتيجة استيفاء الأوراق لوظيفة مهندس مدني | اعلان رقم 2 لسنة 2018" /> 
    ...
    <title>نتيجة استيفاء الأوراق لوظيفة مهندس مدني | اعلان رقم 2 لسنة 2018 </title>
...
<body>
    <div class="container text-center">
        ...
        <div class="all">
            <div class="header">
                <h3>
                    نتيجة استيفاء الأوراق للمتقدمين للاعلان رقم (2) لسنة 2018
                </h3>
                <h4>
                    وظيفة مهندس مدني
