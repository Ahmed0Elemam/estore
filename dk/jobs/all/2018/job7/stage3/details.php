...
$arr_study = array(
1 => "أقل من المتوسط",
2 => "اجادة القراءة والكتابة (صلاحية)"
);
...
//database query
	...
	$sql = "select * from ad7_2018_driver_stage3
			where id = {$id}";
...
<head>
    ...
    <meta property="og:title"  content="نتيجة استيفاء الأوراق  لوظيفة سائق اعلان 7 لسنة 2018" /> 
    ...
    <title>نتيجة استيفاء الأوراق لوظيفة سائق اعلان رقم 7 لسنة 2018 </title>
...
<body>
    <div class="container text-center">
        ...
        <div class="all">
            <div class="header">
                <h3>
                     نتيجة استيفاء الأوراق للمتقدمين للاعلان رقم 7 لسنة 2018
                </h3>
				...
				if($sqlData){ ?>
                        ...
                        <tr>
                         ...
                         <tr>
                            <td class='text-center info' style='color:#000;vertical-align:middle;'>درجة القيادة المتقدم بها</td>
                            <td>
