...
$stmt = $db_con->prepare("SELECT * FROM news_users WHERE user_id=:uid");
...
<div class="container">
    <div class='alert alert-success'>
		<button class='close' data-dismiss='alert'>&times;</button>
			<strong>أهلاً وسهلاً  '<?php echo $row['user_name']; ?></strong>  مرحباً بكم في نظام البحث عن عملاء شركة مياه الشرب والصرف الصحي بالدقهلية
    </div>
</div>
