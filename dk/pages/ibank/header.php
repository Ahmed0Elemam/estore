...
<head>
  ...
  <meta property="og:image" content="http://www.dkwasc.com.eg/img/protocols/dkib.png" /> 
    ...
    <div class="container">
      ...
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-left">
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle<?php setActive('khdma'); ?>" data-toggle="dropdown" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false">خدمات الشركة <span class="caret"></span></a>
            ...
            <li class="dropdown">
            <a href="#" class="dropdown-toggle<?php setActive('about'); ?>" data-toggle="dropdown" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false">عن الشركة <span class="caret"></span></a>
            <ul class="dropdown-menu">
