            ...
            <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
                ...
                <div class="row">
                    <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12 text-center rights">
                        <p class="text-center">جميع الحقوق محفوظة &copy; <a href="http://www.dkwasc.com.eg">شركة مياه الشرب والصرف الصحي بالدقهلية</a> <span class="ar" style="font-size:18px;"><?php echo date("Y"); ?></span></p>
                    </div>
                </div>
            </div>
