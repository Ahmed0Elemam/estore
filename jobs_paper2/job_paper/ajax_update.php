...
*/
    ...
    $stmt = $connect->prepare('update job3_2020_lawer_stage3 set paper_result = 3, reason1 = null, reason2 = null, reason3 = null, notes = null, paper_entry_date = null  where id = ?');
 ...
 <script language='javascript' src='js/script2.js?<?php echo md5_file('js/script2.js')?>' type='text/javascript'></script>";
    ...
    $stmt = $connect->prepare('update job3_2020_lawer_stage3 set paper_result = ?, reason1 = NULL, reason2 = NULL, reason3 = NULL, notes = ?, paper_entry_date = now()  where id = ?');
...
elseif (isset($paper_result) && $paper_result == 3) {
    ...
    $stmt = $connect->prepare('update job3_2020_lawer_stage3 set paper_result = ?, reason1 = NULL, reason2 = NULL, reason3 = NULL, notes = NULL, paper_entry_date = now()  where id = ?');
 ...
 elseif (  $paper_result == 2 && !empty($reason1)  ) {
    ...
    $stmt = $connect->prepare('update job3_2020_lawer_stage3 set paper_result = ?, reason1 = ?, reason2 = ?, reason3 = ?, notes = ?, paper_entry_date = now()  where id = ?');
