...
$stmt = $connect->prepare('select * from job3_2020_lawer_stage3 as s3 right join job3_2020_lawer_stage2 as s2 on s3.id = s2.id where s3.id = ?');
$stmt->execute(array($id));
$details = $stmt->fetchAll();

$stmt2 = $connect->prepare('select * from paper_reasons where reason_id NOT IN(4,5,6,9,16)');
$stmt2->execute();
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="row">
							...
							<div class="col-md-6">
                                <div class="col-md-4">
                                    <label> المؤهل المتقدم به</label> 
                                </div>
                                <div class="col-md-8">
                                <input id="study_name" class="form-control" type="text" name="study_name" readonly value="<?php echo $detail['study_name'] ?>"    />
                    ...
                    <div class="form-group">
                        <div class="row">
							...
							<div class="col-md-6">
                                ...
                                <div class="col-md-8">
                                <input class="form-control" type="text" name="university" readonly value="<?php echo $detail['university'] ?>"    />
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-8">
                                <input class="form-control" type="text" name="college" readonly value="<?php echo $detail['college'] ?>"    />
