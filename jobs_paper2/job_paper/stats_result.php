...
include 'connect.php';
$stmt4 = $connect->prepare('select * from job3_2020_lawer_stage3 as s3 right join  job3_2020_lawer_stage2 as s2 ON s3.id = s2.id where s3.paper_entry_date >= ? and s3.paper_entry_date <= ? ');
