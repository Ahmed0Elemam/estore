...
<hr/>
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <h3>السيد / مدير منشأة <?php echo $name ?> </h3>
    
               
                <h4 class="text-center">تحية طيبة وبعد ،،،</h4>
        
                <br/>
                <h4 class="text-justify">الرجاء من سيادتكم سداد رسوم أعباء التنقية الخاصة بمنشأتكم</h4>
  
                <h4><strong> كود المنشأة / </strong> <span><?php echo $code ?></span></h4>
                <h4><strong> مسمى المنشأة / </strong> <span><?php echo $name ?></span></h4>
                
                 <h4><strong>نتائج الملوثات  </strong></h4>
                 <table class="table">
                    <thead>
                        <th>الملوث</th>
                        <th>النتيجة</th>
                    ...
                    <tbody>
                       <tr class="text-center">
                          <td class="text-center">BOD</td>
                          <td class="text-center"><?php echo $bod; ?></td>
                       </tr>
                         <tr class="text-center">
                          <td class="text-center">COD</td>
                          <td class="text-center"><?php echo $cod; ?></td>
                       </tr>
                         <tr class="text-center">
                          <td class="text-center">TSS</td>
                          <td class="text-center"><?php echo $tss; ?></td>
                       </tr>
                         <tr class="text-center">
                          <td class="text-center">PH</td>
                          <td class="text-center"><?php echo $ph; ?></td>
                       </tr>
                         <tr class="text-center">
                          <td class="text-center">O &amp; G</td>
                          <td class="text-center"><?php echo $og; ?></td>
                       </tr>
