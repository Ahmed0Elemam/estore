...
<div id="details" class="alert alert-info">
    <p>
        <?php echo $arr_treatment_type[intval($treatment_type)]; ?>  / 
        <?php echo $arr_type[intval($type)]; ?>  / 
...
<div class="row">
        ...
        <br/>
            ...
            <button type="submit" id="move" class="btn btn-info" type="button">أرشفة الملفات</button>
...
<h4>رفع ملفات</h4>
       ...
       <div class="col">
       <input name="files[]" type="file" id="files" class="form-control"  multiple="multiple" />
