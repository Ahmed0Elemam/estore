...
window.history.replaceState("", "", 'نظام_الأرشفة_الالكترونية_للملفات_ادارة_تكنولوجيا_المعلومات');
    ...
    $("#move_g").click(function () {
      ...
      var user_id_val = user_id;
          ajax_URL = "move_g.php",
          dataString = 'tr_type=' + treatment_type_val + '&type=' + type_val + '&tr_id' + treatment_id_val + '&tr_year' + treatment_year_val + '&dept' + department_val + '&cat' + treatment_cat_val  +  '&user_id'  + user_id_val ;
        
        $('#Info').html('');
    
        //debugger;
     if ( treatment_id_val !=0 && treatment_year_val !=0 && department_val !=0 && treatment_cat_val !=0    ) {
